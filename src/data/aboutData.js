/**
 * About page content – extracted from AboutJane, ReikiMeaning, OriginOfReiki, Footer, Testimonial.
 */
...
export const ABOUT = {
  ...
  introParagraphs: [
    "I am a trained practitioner for shamanic energy medicine, medical Qigong, and life coaching. My work bridges cultures, traditions, religions, and identities. It holds unconditional respect for who you are and where you are from.",
...
export const JOURNEY = [
  ...
  { year: "Training", title: "Integrative systems", text: "Formal training in shamanic energy medicine, Medical Qigong, and life coaching—each adding a layer to a holistic practice." },
