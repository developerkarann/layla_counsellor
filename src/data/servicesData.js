/**
 * Services content extracted from Levels + Benefits (home).
 * Three main services: Shamanic Healing, TCK Holistic Coaching, Medical Qigong.
 */
...
export const SERVICES = [
  ...
  },
  {
    ...
    image: "/h3.JPG",
    imageAlt: "Medical Qigong practice",
    keyPoints: [
    ...
    description: "Medical Qigong is a branch of Chinese medicine that uses movement, breath, and intention to support the body’s natural ability to heal. Unlike exercise alone, it works with the subtle energy (qi) that animates your systems—helping to clear blockages, strengthen weak areas, and restore a sense of ease and vitality.",
